...
for x in range(250):
    ...
    t.goto(random.randint(-800, 800), random.randint(-600, 600))
    t.down()

    t.write('🧡', font=('Calibri', random.randint(9, 28), 'bold'))
    t.end_fill()
...
draw.pen(pencolor="white",fillcolor="yellow", pensize=3, speed=1.001)
